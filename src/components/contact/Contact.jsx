...
const Contact = () => {
    return (
        <>
            <div className='h-screen bg-contact  bg-no-repeat flex flex-col justify-center  items-center  bg-cover bg-[center_left_-240px] md:hidden sm:hidden'>
                <div className='pl-10 pr-8 w-full'>
                    <h1 className='text-5xl text-white font-semibold'>Contact</h1>
