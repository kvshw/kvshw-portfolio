        ...
        <>
            <div className='h-screen bg-mobile-header  bg-no-repeat flex flex-col justify-center  items-center bg-[center_left_-170px] bg-cover md:hidden sm:hidden'>
                <div className='pl-10 pr-8'>
                    <h1 className='text-4xl text-white font-semibold'>Kavishwa Wendakoon</h1>
                    <h3 className='text-xl text-white font-medium mt-1'>Transforming Complex Ideas into Elegant Code</h3>
                    <p className='text-sm text-white font-thin mt-4'>From complex ideas to elegant
                        code - with a keen eye for detail
                        and a passion for innovation,
                        I bring your ideas to life one line
                        of code at a time.</p>
                    <div className='self-baseline'>
                        <button className='text-black px-8 py-2 bg-white rounded-3xl text-xs mt-4'>Download Resume</button>
                    </div>
                </div>
                <div className='flex flex-row justify-between w-full absolute bottom-0 h-[25vh] items-end'>
                    <div className=''>
                        <h4 className='text-white text-[10px] rotate-[-90deg] relative bottom-[70px] left-[-35px]'>SCROLL TO SEE MORE</h4>
